...
class BlameActiveLineController extends vscode_1.Disposable {
    ...
    _onConfigurationChanged() {
        ...
        if (!system_1.Objects.areEquivalent(config.blame.annotation.activeLineDarkColor, this._config && this._config.blame.annotation.activeLineDarkColor) ||
            !system_1.Objects.areEquivalent(config.blame.annotation.activeLineLightColor, this._config && this._config.blame.annotation.activeLineLightColor)) {
            changed = true;
        }
        this._config = config;
        if (!changed)
