...
class DiffWithPreviousCommand extends common_1.ActiveEditorCommand {
    ...
    run(context, args = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (context.type) {
                case 'uri':
                    return this.execute(context.editor, context.uri, Object.assign({}, args));
                case 'scm-states':
                    const resource = context.scmResourceStates[0];
                    return this.execute(undefined, resource.resourceUri, Object.assign({}, args));
                case 'scm-groups':
                    return undefined;
                default:
                    return this.execute(context.editor, undefined, Object.assign({}, args));
            }
        });
    }
