...
class ImportManager {
    constructor(document, _parsedDocument, parser, config, logger, generatorFactory) {
        ...
        this.imports = [];
        this.logger.debug(`[ImportManager] create import manager`, { file: document.fileName });
        this.reset();
    }
    get rootPath() {
    ...
    organizeImports() {
        this.logger.debug('[ImportManager] organize the imports', { file: this.document.fileName });
        this.organize = true;
        let keep = [];
    ...
    commit() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            this.logger.debug('[ImportManager] commit the file', { file: this.document.fileName });
