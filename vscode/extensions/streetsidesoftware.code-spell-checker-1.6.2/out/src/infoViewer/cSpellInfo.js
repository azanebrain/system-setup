...
function activate(context, client) {
    ...
    context.subscriptions.push(subOnDidChangeEditor, subOnDidChangeDoc, vscode.commands.registerCommand(exports.commandDisplayCSpellInfo, displayCSpellInfo), vscode.commands.registerCommand(exports.commandEnableLanguage, enableLanguage), vscode.commands.registerCommand(exports.commandDisableLanguage, disableLanguage), vscode.commands.registerCommand(exports.commandSetLocal, setLocal), vscode.commands.registerCommand(exports.commandOverrideLocalSetting, overrideLocalSetting), vscode.commands.registerCommand(exports.commandSelectInfoTab, selectInfoTab), registration, makeDisposable(subOnDidChangeTextDocument));
}
