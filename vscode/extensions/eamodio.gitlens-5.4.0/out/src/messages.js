...
class Messages {
    ...
    static showCommitHasNoPreviousCommitWarningMessage(commit) {
        if (commit === undefined)
            return Messages._showMessage('info', `Commit has no previous commit`, exports.SuppressedKeys.CommitHasNoPreviousCommitWarning);
        return Messages._showMessage('info', `Commit ${commit.shortSha} (${commit.author}, ${commit.fromNow()}) has no previous commit`, exports.SuppressedKeys.CommitHasNoPreviousCommitWarning);
    }
    ...
    static showWelcomeMessage() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield Messages._showMessage('info', `Thank you for choosing GitLens! GitLens is powerful, feature rich, and highly configurable, so please be sure to view the docs and tailor it to suit your needs.`, exports.SuppressedKeys.WelcomeNotice, null, viewDocs);
            if (result === viewDocs) {
