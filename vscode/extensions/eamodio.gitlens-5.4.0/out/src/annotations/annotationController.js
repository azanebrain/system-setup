...
class AnnotationController extends vscode_1.Disposable {
    ...
    showAnnotations(editor, type, shaOrLine) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (currentProvider !== undefined && comparers_1.TextEditorComparer.equals(currentProvider.editor, editor)) {
            ...
            return vscode_1.window.withProgress({ location: vscode_1.ProgressLocation.Window }, (progress) => __awaiter(this, void 0, void 0, function* () {
                yield constants_1.setCommandContext(constants_1.CommandContext.AnnotationStatus, 'computing');
                ...
                yield constants_1.setCommandContext(constants_1.CommandContext.AnnotationStatus, result ? 'computed' : undefined);
                return computingAnnotations;
            }));
        });
    }
    _showAnnotationsCore(currentProvider, editor, type, shaOrLine, progress) {
        return __awaiter(this, void 0, void 0, function* () {
