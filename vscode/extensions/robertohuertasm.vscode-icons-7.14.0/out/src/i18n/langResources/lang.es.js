...
exports.langEs = {
    newVersion: `Bienvenido a la nueva versión de ${constants_1.constants.extensionName}`,
    ...
    welcome: `Gracias por instalar ${constants_1.constants.extensionName}`,
    activate: 'Activar',
    ...
    ngDetected: `${constants_1.constants.extensionName} ha detectado un proyecto Angular. ` +
        'Pulsar \'Reiniciar\' para activar los iconos de Angular.',
    nonNgDetected: `${constants_1.constants.extensionName} ha detectado un proyecto no Angular. ` +
