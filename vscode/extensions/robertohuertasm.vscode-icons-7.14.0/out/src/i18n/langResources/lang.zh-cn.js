...
exports.langZhCn = {
    newVersion: `欢迎使用最新版本的 ${constants_1.constants.extensionName}`,
    seeReleaseNotes: '关于最新版本的改动',
    dontShowThis: '下次不再显示这条消息',
    seeReadme: '了解关于此插件的更多信息',
    welcome: `感谢安装 ${constants_1.constants.extensionName}`,
    activate: '激活',
    ...
    restart: '选择「重启」使改变生效',
    ngDetected: `${constants_1.constants.extensionName} 发现当前工程是 Angular。选择「重启」使用 Angular 的图标`,
    nonNgDetected: `${constants_1.constants.extensionName} 发现当前工程不是 Angular。选择「重启」取消使用 Angular 的图标`,
    projectDetectionReset: '重设自动检测工程文件为默认设置',
};
//# sourceMappingURL=lang.zh-cn.js.map