...
class VscodeResolverConfig {
    ...
    get workspaceIgnorePatterns() {
        return this.workspaceSection.get('workspaceIgnorePatterns', [
            '**/build/**/*',
            '**/out/**/*',
            '**/dist/**/*',
        ]);
    }
    get moduleIgnorePatterns() {
        return this.workspaceSection.get('moduleIgnorePatterns', [
            '**/node_modules/**/*',
        ]);
    }
    ...
    get organizeSortsByFirstSpecifier() {
