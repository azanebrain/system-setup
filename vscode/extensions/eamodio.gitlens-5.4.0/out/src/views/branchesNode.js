...
class BranchesNode extends explorerNode_1.ExplorerNode {
    constructor(uri, context, git) {
        ...
        this.git = git;
        this.resourceType = 'gitlens:branches';
    }
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return [...system_1.Iterables.filterMap(branches, b => b.remote ? undefined : new branchHistoryNode_1.BranchHistoryNode(b, this.uri, this.context, this.git))];
        });
    }
    getTreeItem() {
        return __awaiter(this, void 0, void 0, function* () {
