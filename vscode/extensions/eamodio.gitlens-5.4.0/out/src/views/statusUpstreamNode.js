...
class StatusUpstreamNode extends explorerNode_1.ExplorerNode {
    constructor(status, direction, context, git) {
        ...
        this.git = git;
        this.resourceType = 'gitlens:status-upstream';
    }
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let log = yield this.git.getLogForRepo(this.uri.repoPath, range, 0);
            if (log === undefined)
                return [];
            ...
            if (commit.previousSha === undefined) {
                log = yield this.git.getLogForRepo(this.uri.repoPath, commit.sha, 2);
                if (log !== undefined) {
                    commits[commits.length - 1] = system_1.Iterables.first(log.commits.values());
                }
            }
            return [...system_1.Iterables.map(commits, c => new commitNode_1.CommitNode(c, this.context, this.git))];
        });
    }
    getTreeItem() {
        return __awaiter(this, void 0, void 0, function* () {
