    ...
    provideCodeLenses(document, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (commit.previousSha) {
                lenses.push(new GitDiffWithPreviousCodeLens(this.git, commit.previousUri.fsPath, commit, new vscode_1.Range(0, 0, 0, 1)));
            }
            lenses.push(new GitDiffWithWorkingCodeLens(this.git, commit.uri.fsPath, commit, new vscode_1.Range(0, 1, 0, 2)));
            return lenses;
        });
    }
