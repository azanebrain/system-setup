...
exports.langEn = {
    newVersion: `Welcome to the new version of ${constants_1.constants.extensionName}.`,
    ...
    welcome: `Thanks for installing ${constants_1.constants.extensionName}`,
    activate: 'Activate',
    ...
    ngDetected: `${constants_1.constants.extensionName} has detected an Angular project. ` +
        'Select \'Restart\' to enable the Angular icons.',
    nonNgDetected: `${constants_1.constants.extensionName} has detected a non Angular project. ` +
