    ...
    handleDiagnostic(document, commands, diagnostic) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (infos.length > 0) {
                ...
                commands.push(this.createCommand(`Cannot find "${match[2]}" in the index.`, new CodeAction_1.NoopCodeAction()));
                this.logger.debug('[%s] class not found in index', MissingImportCreator_1.name, { specifier: match[2] });
            }
            return commands;
        });
    }
