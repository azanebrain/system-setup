    ...
    constructor(document, range, dockerfile, escapeChar, instruction, instructionRange) {
        ...
        argsCheck: for (let i = 0; i < argsContent.length; i++) {
            switch (argsContent.charAt(i)) {
                ...
                case ',':
                    if (!quoted) {
                        this.jsonStrings.push(new argument_1.Argument(argsContent.substring(fullStart, i), argsContent.substring(fullStart, i), vscode_languageserver_1.Range.create(document.positionAt(argsOffset + fullStart), document.positionAt(argsOffset + i))));
                        fullStart = i + 1;
                        if (last === '"') {
                            last = ',';
                        }
