...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        factory_1.RemoteProviderFactory.configure(context);
        ...
        context.subscriptions.push(new commands_2.ExternalDiffCommand(git));
        ...
        context.subscriptions.push(new commands_5.DiffWithCommand(git));
        ...
        context.subscriptions.push(new commands_5.DiffWithRevisionCommand(git));
        context.subscriptions.push(new commands_5.DiffWithWorkingCommand(git));
        context.subscriptions.push(new commands_3.OpenBranchesInRemoteCommand(git));
        context.subscriptions.push(new commands_3.OpenBranchInRemoteCommand(git));
        ...
        context.subscriptions.push(new commands_3.OpenRepoInRemoteCommand(git));
        context.subscriptions.push(new commands_7.ClearFileAnnotationsCommand(annotationController));
        context.subscriptions.push(new commands_7.ShowFileBlameCommand(annotationController));
        context.subscriptions.push(new commands_7.ShowLineBlameCommand(currentLineController));
        context.subscriptions.push(new commands_7.ToggleFileBlameCommand(annotationController));
        context.subscriptions.push(new commands_7.ToggleFileRecentChangesCommand(annotationController));
        context.subscriptions.push(new commands_7.ToggleLineBlameCommand(currentLineController));
        context.subscriptions.push(new commands_6.ResetSuppressedWarningsCommand(context));
        context.subscriptions.push(new commands_8.ShowBlameHistoryCommand(git));
        context.subscriptions.push(new commands_8.ShowFileHistoryCommand(git));
        context.subscriptions.push(new commands_9.ShowLastQuickPickCommand());
        context.subscriptions.push(new commands_10.ShowQuickBranchHistoryCommand(git));
        context.subscriptions.push(new commands_10.ShowQuickCurrentBranchHistoryCommand(git));
        context.subscriptions.push(new commands_11.ShowQuickCommitDetailsCommand(git));
        context.subscriptions.push(new commands_11.ShowQuickCommitFileDetailsCommand(git));
        context.subscriptions.push(new commands_11.ShowCommitSearchCommand(git));
        context.subscriptions.push(new commands_10.ShowQuickFileHistoryCommand(git));
        context.subscriptions.push(new commands_12.ShowQuickRepoStatusCommand(git));
        context.subscriptions.push(new commands_12.ShowQuickStashListCommand(git));
        context.subscriptions.push(new commands_13.StashApplyCommand(git));
        context.subscriptions.push(new commands_13.StashDeleteCommand(git));
        context.subscriptions.push(new commands_13.StashSaveCommand(git));
        context.subscriptions.push(new commands_14.ToggleCodeLensCommand(codeLensController));
    });
}
