...
function compose(command, message, dockerComposeFileUri) {
    return __awaiter(this, void 0, void 0, function* () {
        let folder;
        ...
        if (dockerComposeFileUri) {
            ...
            selectedItem = (yield vscode.window.showQuickPick(items, { placeHolder: `Choose Docker Compose file ${message}` }));
        }
        if (selectedItem) {
...
function composeUp(dockerComposeFileUri) {
    compose('up', 'to bring up', dockerComposeFileUri);
}
exports.composeUp = composeUp;
function composeDown(dockerComposeFileUri) {
