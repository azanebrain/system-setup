    ...
    preExecute(context, args = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            if (context.type === 'scm-states') {
                ...
                const isModified = (status) => status === Status.BOTH_MODIFIED || status === Status.INDEX_MODIFIED || status === Status.MODIFIED;
                args = Object.assign({}, args);
                args.files = context.scmResourceGroups[0].resourceStates
                    .filter((r) => isModified(r.type))
                    .map((r) => new ExternalDiffFile(r.resourceUri, r.resourceGroupType === ResourceGroupType.Index));
                return this.execute(args);
            }
            return this.execute(args);
    ...
    execute(args = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const repoPath = yield this.git.getRepoPathFromUri(undefined);
                if (!repoPath)
