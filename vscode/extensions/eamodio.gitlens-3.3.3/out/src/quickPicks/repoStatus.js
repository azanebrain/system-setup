...
class RepoStatusQuickPick {
    static show(status, goBackCommand) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            }, commands_1.Commands.ShowQuickRepoStatus, [undefined, goBackCommand]);
            if (hasStaged) {
                let index = 0;
            ...
            }, commands_1.Commands.ShowQuickStashList, [new gitService_1.GitUri(vscode_1.Uri.file(status.repoPath), { fileName: '', repoPath: status.repoPath }), currentCommand]));
