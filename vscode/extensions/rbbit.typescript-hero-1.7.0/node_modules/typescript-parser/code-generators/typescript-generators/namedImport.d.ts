 ...
 * @returns {string}
 */
export declare function generateNamedImport(imp: NamedImport, {eol, stringQuoteStyle, spaceBraces, tabSize, multiLineWrapThreshold, multiLineTrailingComma}: TypescriptGenerationOptions): string;
