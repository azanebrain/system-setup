...
class StatusFileCommitsNode extends explorerNode_1.ExplorerNode {
    constructor(repoPath, status, commits, context, git, branch) {
        ...
        this.git = git;
        this.branch = branch;
        this.resourceType = 'gitlens:status-file-commits';
    }
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.commits.map(c => new commitFileNode_1.CommitFileNode(this.status, c, this.context, this.git, commitFileNode_1.CommitFileNodeDisplayAs.Commit, this.branch));
        });
    }
    getTreeItem() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    get label() {
        if (this._label === undefined) {
            this._label = gitService_1.StatusFileFormatter.fromTemplate(this.git.config.gitExplorer.statusFileFormat, Object.assign({}, this.status, { commit: this.commit }), { relativePath: this.relativePath });
        }
        return this._label;
    }
    get commit() {
