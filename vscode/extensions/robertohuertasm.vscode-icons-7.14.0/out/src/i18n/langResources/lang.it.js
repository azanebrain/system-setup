...
exports.langIt = {
    newVersion: `Benvenuto alla nuova versione di ${constants_1.constants.extensionName}.`,
    ...
    welcome: `Grazie per aver installato ${constants_1.constants.extensionName}`,
    activate: 'Attiva',
    ...
    ngDetected: `${constants_1.constants.extensionName} ha rilevato un progetto Angular. ` +
        'Seleziona \'Riavvia\' per abilitare le icone Angular.',
    nonNgDetected: `${constants_1.constants.extensionName} ha rilevato un progetto non Angular. ` +
