...
exports.langRu = {
    newVersion: `Добро пожаловать в новую версию ${constants_1.constants.extensionName}.`,
    ...
    welcome: `Спасибо, что установили ${constants_1.constants.extensionName}`,
    ...
    ngDetected: `${constants_1.constants.extensionName} обнаружил проект Angular. ` +
        'Нажмите \'Перезапустить\' чтобы включить значки Angular.',
    nonNgDetected: `${constants_1.constants.extensionName} обнаружил проект отличный от Angular. ` +
