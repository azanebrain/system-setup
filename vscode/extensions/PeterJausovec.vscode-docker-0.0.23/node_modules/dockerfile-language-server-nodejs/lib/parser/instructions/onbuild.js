...
const dockerfileParser_1 = require("../dockerfileParser");
...
class Onbuild extends instruction_1.Instruction {
    ...
    getTriggerInstruction() {
        ...
        let args = this.getArguments();
        return dockerfileParser_1.DockerfileParser.createInstruction(this.document, this.dockerfile, this.escapeChar, vscode_languageserver_1.Range.create(args[0].getRange().start, this.getRange().end), this.getTriggerWord(), triggerRange);
    }
}
