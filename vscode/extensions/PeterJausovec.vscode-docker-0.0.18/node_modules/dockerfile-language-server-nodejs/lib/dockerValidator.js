...
class Validator {
    ...
    parseDirective(dockerfile, document, problems) {
        ...
        if (directiveName === docker_1.DIRECTIVE_ESCAPE) {
            ...
            if (directive.getName() !== docker_1.DIRECTIVE_ESCAPE) {
        ...
        if (keywords.indexOf(keyword) === -1) {
            ...
            validateInstruction: switch (keyword) {
                case "CMD":
                    ...
                    break;
                case "ARG":
                    this.checkArguments(instruction, problems, [-1], function (index, argument) {
                        if (index > 0) {
                ...
                case "LABEL":
                    ...
                    let properties = instruction instanceof env_1.Env ? instruction.getProperties() : instruction.getProperties();
    ...
    static createFlagUnknown(start, end, flag) {
