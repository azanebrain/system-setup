...
exports.langDe = {
    newVersion: `Willkommen zur neuen Version von ${constants_1.constants.extensionName}.`,
    ...
    welcome: `Danke für das Installieren von ${constants_1.constants.extensionName}`,
    activate: 'Aktivieren',
    ...
    ngDetected: `${constants_1.constants.extensionName} hat ein Angular Projekt erkannt! ` +
        'Drücken Sie \'Neu starten\', damit die Angular Icons übernommen werden.',
    nonNgDetected: `${constants_1.constants.extensionName} hat ein nicht Angular Projekt erkannt! ` +
