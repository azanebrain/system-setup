...
class ImportManager {
    ...
    static create(document) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const source = yield ImportManager.parser.parseSource(document.getText(), utilityFunctions_1.getScriptKind(document.fileName));
    ...
    organizeImports() {
        ...
        if (!this.config.resolver.disableImportSorting) {
            const sorter = this.config.resolver.organizeSortsByFirstSpecifier
                ? utilityFunctions_1.importSortByFirstSpecifier
                : utilityFunctions_1.importSort;
            keep = [
    ...
    commit() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (result) {
                ...
                this._parsedDocument = yield ImportManager.parser.parseSource(this.document.getText(), utilityFunctions_1.getScriptKind(this.document.fileName));
                this.imports = this._parsedDocument.imports.map(o => o.clone());
                for (const group of this.importGroups) {
                    group.reset();
                }
    ...
    addImportsToGroups(imports) {
        const importGroupsWithPrecedence = utilityFunctions_1.importGroupSortForPrecedence(this.importGroups);
