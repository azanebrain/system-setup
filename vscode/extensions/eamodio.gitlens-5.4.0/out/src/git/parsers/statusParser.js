    ...
    static _parseV1(lines, repoPath, status) {
        ...
        while (++position < lines.length) {
            ...
            if (line.startsWith('##')) {
                ...
                status.files.push(new git_1.GitStatusFile(repoPath, entry.status, entry.workTreeStatus, entry.indexStatus, entry.fileName, entry.staged, entry.originalFileName));
            }
        }
    }
