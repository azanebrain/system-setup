...
class SubscriptionBasedWizardStep extends wizard_1.WizardStep {
...
class WebsiteStep extends SubscriptionBasedWizardStep {
    ...
    prompt() {
        return __awaiter(this, void 0, void 0, function* () {
            const subscription = this.getSelectedSubscription();
            const client = new WebSiteManagementClient(this.azureAccount.getCredentialByTenantId(subscription.tenantId), subscription.subscriptionId);
            const siteName = yield this.showInputBox({
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let siteConfig = yield websiteClient.webApps.getConfiguration(rg.name, this._website.name);
            ...
            let updatedConfig = yield websiteClient.webApps.createOrUpdateConfiguration(rg.name, this._website.name, siteConfig);
            let appSettings;
            ;
            if (this._serverUrl.length > 0) {
                // azure container registry
