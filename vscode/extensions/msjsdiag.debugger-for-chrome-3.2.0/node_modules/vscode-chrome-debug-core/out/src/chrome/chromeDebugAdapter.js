...
class ScriptEvent extends vscode_debugadapter_1.Event {
    constructor(reason, script) {
...
class ChromeDebugAdapter {
    ...
    commonArgs(args) {
        if (args.trace === 'verbose') {
            vscode_debugadapter_1.logger.setup(vscode_debugadapter_1.Logger.LogLevel.Verbose, /*logToFile=*/ true);
        }
        else if (args.trace) {
            vscode_debugadapter_1.logger.setup(vscode_debugadapter_1.Logger.LogLevel.Warn, /*logToFile=*/ true);
        }
        else if (args.verboseDiagnosticLogging) {
            vscode_debugadapter_1.logger.setup(vscode_debugadapter_1.Logger.LogLevel.Verbose, /*logToFile=*/ true);
        }
        else if (args.diagnosticLogging) {
            vscode_debugadapter_1.logger.setup(vscode_debugadapter_1.Logger.LogLevel.Log, /*logToFile=*/ true);
        }
        else {
            vscode_debugadapter_1.logger.setup(vscode_debugadapter_1.Logger.LogLevel.Warn, /*logToFile=*/ false);
        }
    ...
    doAttach(port, targetUrl, address, timeout, websocketUrl, extraCRDPChannelPort) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this._chromeConnection.isAttached) {
                ...
                try {
                    return yield this.chrome.Debugger.setAsyncCallStackDepth({ maxDepth });
                }
                catch (e) {
        ...
        smartStepP.then(should => {
            if (should) {
                ...
                const sendStoppedEvent = () => {
                    ...
                    return this._session.sendEvent(new stoppedEvent_1.StoppedEvent2(reason, /*threadId=*/ ChromeDebugAdapter.THREAD_ID, exceptionText));
                };
     ...
     */
    sendScriptEvents(script) {
        return __awaiter(this, void 0, void 0, function* () {
            const scriptEvent = yield this.scriptToScriptEvent(script);
            ...
            this._session.sendEvent(new vscode_debugadapter_1.Event('scriptLoaded', { path: displayPath }));
        });
    }
    ...
    onExceptionThrown(params) {
        ...
        this.mapFormattedException(formattedException).then(exceptionStr => {
            this._session.sendEvent(new vscode_debugadapter_1.OutputEvent(exceptionStr + '\n', 'stderr'));
        });
    }
    ...
    setBreakpoints(args, requestSeq, ids) {
        ...
        return this.validateBreakpointsPath(args)
            ...
            if (targetScriptUrl) {
                ...
                const setBreakpointsPTimeout = utils.promiseTimeout(setBreakpointsPFailOnError, ChromeDebugAdapter.SET_BREAKPOINTS_TIMEOUT, localize(2, null));
                ...
                return Promise.resolve(this.unverifiedBpResponse(args, requestSeq, localize(3, null)));
            }
    ...
    validateBreakpointsPath(args) {
        ...
        return this._sourceMapTransformer.getGeneratedPathFromAuthoredPath(args.source.path).then(mappedPath => {
            ...
            if (!targetPath) {
                return utils.errP(localize(5, null));
            }
            return undefined;
        });
    }
    ...
    targetBreakpointResponsesToClientBreakpoints(url, responses, requestBps, ids) {
        ...
        return responses
            ...
            if (thisBpRequest.hitCondition) {
                if (!this.addHitConditionBreakpoint(thisBpRequest, response)) {
                    return {
                        id: bpId,
                        message: localize(6, null, thisBpRequest.hitCondition),
                        verified: false
                    };
                }
            }
    ...
    stackTrace(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(stackTraceResponse.stackFrames.map((frame, i) => __awaiter(this, void 0, void 0, function* () {
                ...
                const getSkipReason = reason => localize(7, null, reason);
    ...
    scriptToScriptEvent(script) {
        ...
        return utils.existsAsync(script.url)
            ...
            const clientScript = new Script(source);
