    ...
    analyzeDiagnostics(diagnostics, textDocumentURI) {
        ...
        for (let i = 0; i < diagnostics.length; i++) {
            ...
            switch (diagnostics[i].code) {
                case dockerValidator_1.ValidationCode.CASING_DIRECTIVE:
                    commands.push({
                    ...
                    break;
                case dockerValidator_1.ValidationCode.CASING_INSTRUCTION:
                    commands.push({
                    ...
                    break;
                case dockerValidator_1.ValidationCode.ARGUMENT_EXTRA:
                    commands.push({
                    ...
                    break;
                case dockerValidator_1.ValidationCode.INVALID_ESCAPE_DIRECTIVE:
                    commands.push({
                    ...
                    break;
                case dockerValidator_1.ValidationCode.INVALID_AS:
                    commands.push({
                        title: "Convert to AS",
                    ...
                    break;
                case dockerValidator_1.ValidationCode.UNKNOWN_HEALTHCHECK_FLAG:
                    commands.push({
                    ...
                    break;
                case dockerValidator_1.ValidationCode.UNKNOWN_ADD_FLAG:
                    commands.push({
                    ...
                    break;
                case dockerValidator_1.ValidationCode.UNKNOWN_COPY_FLAG:
                    commands.push({
                        title: "Convert to --chown",
                        command: CommandIds.FLAG_TO_CHOWN,
                        arguments: [textDocumentURI, diagnostics[i].range]
