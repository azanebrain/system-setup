...
class ShowBlameCommand extends commands_1.EditorCommand {
    constructor(annotationController) {
        super(constants_1.Commands.ShowBlame);
    ...
    execute(editor, edit, uri, sha) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logger_1.Logger.error('GitLens.ShowBlameCommand', ex);
...
exports.default = ShowBlameCommand;
