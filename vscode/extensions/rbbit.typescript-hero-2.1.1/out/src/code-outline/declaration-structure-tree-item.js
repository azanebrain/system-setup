...
const fileTemplate = StringTemplate_1.stringTemplate `./src/assets/icons/declarations/${0}.svg`;
...
class DeclarationStructureTreeItem extends base_structure_tree_item_1.default {
    ...
    get iconPath() {
        switch (utility_functions_1.getItemKind(this.declaration)) {
        ...
        if (utility_functions_1.getItemKind(this.declaration) === vscode_1.CompletionItemKind.Variable) {
...
exports.default = DeclarationStructureTreeItem;
