...
class OpenBranchesInRemoteCommand extends common_1.ActiveEditorCommand {
    constructor(git) {
        super(common_1.Commands.OpenBranchesInRemote);
        this.git = git;
    }
    ...
    execute(editor, uri, args = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                logger_1.Logger.error(ex, 'OpenBranchesInRemoteCommand');
                return vscode_1.window.showErrorMessage(`Unable to open branches in remote provider. See output channel for more details`);
            }
        });
    }
}
exports.OpenBranchesInRemoteCommand = OpenBranchesInRemoteCommand;
//# sourceMappingURL=openBranchesInRemote.js.map