...
class GitService extends vscode_1.Disposable {
    ...
    _onConfigurationChanged() {
        ...
        if (codeLensChanged || advancedChanged) {
            ...
            commands_1.setCommandContext(commands_1.CommandContext.CanToggleCodeLens, config.codeLens.visibility !== configuration_1.CodeLensVisibility.Off && (config.codeLens.recentChange.enabled || config.codeLens.authors.enabled));
        }
        if (advancedChanged) {
